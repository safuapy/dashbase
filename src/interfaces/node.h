...
//! Interface for the src/evo part of a dashbase node (dashbased process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a dashbase node (dashbased process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a dashbase node (dashbased process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a dashbase node (dashbased process).
...
//! Top-level interface for a dashbase node (dashbased process).
class Node
{
public:
    virtual ~Node() {}
