...
public:
    CMainParams() {
        ...
        consensus.nSubsidyHalvingInterval = 210000; // ~4 years at 2 min blocks
        consensus.nMasternodePaymentsStartBlock = 0; // immediate
        consensus.nMasternodePaymentsIncreaseBlock = 0; // immediate
        consensus.nMasternodePaymentsIncreasePeriod = 1; // minimal
        consensus.nInstantSendConfirmationsRequired = 6;
        consensus.nInstantSendKeepLock = 24;
        consensus.nBudgetPaymentsStartBlock = 0; // immediate
        consensus.nBudgetPaymentsCycleBlocks = 10080; // ~2 weeks at 2 min blocks
        consensus.nBudgetPaymentsWindowBlocks = 100;
        consensus.nSuperblockStartBlock = 10080; // first superblock at cycle 1
        consensus.nSuperblockStartHash = uint256(); // no check on fresh chain
        consensus.nSuperblockCycle = 10080; // ~2 weeks at 2 min blocks
        consensus.nSuperblockMaturityWindow = 1440; // ~2 days at 2 min blocks
        ...
        consensus.nPowKGWHeight = 0; // no KGW, DGW from start
        consensus.nPowDGWHeight = 0;
        consensus.nRuleChangeActivationThreshold = 1512; // 75% of 2016
        consensus.nMinerConfirmationWindow = 720; // 86400 / 120
        // All deployments always-active on fresh chain (heights already set to 1)
        ...
        // Deployment of DIP0020 and DIP0021
        ...
        genesis = CreateGenesisBlock(1753734000, 961483, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000872de437c3605386676ec196376df3c12f53ccdc0f8f7d5aa67ad883a71"));
        ...
        vSeeds.emplace_back("dnsseed.dashbase.org");

        // Dashbase addresses start with 'X'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,76);
        // Dashbase script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,16);
        // Dashbase private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,204);
        // Dashbase BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Dashbase BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // Dashbase BIP44 coin type is '5'
        nExtCoinType = 153;
        ...
        // Dashbase spork key (generated by scripts/generate_spork_keys.py)
        // privKey: XFBq8xXYvQr314aba7n4Pcpb5VjnNntmcC9Zn5uQdjTppRNknuzj
        vSporkAddresses = {"XdrPTonAs3n9LQg65EHkWtYCHvj3teewoN"};
        nMinSporkKeys = 1;
...
public:
    CTestNetParams() {
        ...
        consensus.nSuperblockMaturityWindow = 50;
        ...
        consensus.fPowNoRetargeting = false;
        consensus.nPowKGWHeight = 0; // no KGW
        consensus.nPowDGWHeight = 0; // DGW from start
        ...
        // Deployment of BIP68, BIP112, and BIP113.
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].bit = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 0; // activate immediately
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 999999999999ULL;

        // Deployment of DIP0001
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].bit = 1;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nStartTime = 0; // activate immediately
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nTimeout = 999999999999ULL;
        ...
        // Deployment of BIP147
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].bit = 2;
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].nStartTime = 0; // activate immediately
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].nTimeout = 999999999999ULL;
        ...
        // Deployment of DIP0003
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].bit = 3;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nStartTime = 0; // activate immediately
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nTimeout = 999999999999ULL;
        ...
        // Deployment of DIP0008
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].bit = 4;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].nStartTime = 0; // activate immediately
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].nTimeout = 999999999999ULL;
        ...
        // Deployment of Block Reward Reallocation
        consensus.vDeployments[Consensus::DEPLOYMENT_REALLOC].bit = 5;
        consensus.vDeployments[Consensus::DEPLOYMENT_REALLOC].nStartTime = 0; // activate immediately
        consensus.vDeployments[Consensus::DEPLOYMENT_REALLOC].nTimeout = 999999999999ULL;
        ...
        // Deployment of DIP0020 and DIP0021
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0020].bit = 6;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0020].nStartTime = 0; // activate immediately
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0020].nTimeout = 999999999999ULL;
        ...
        // Deployment of Quorum Rotation DIP and decreased proposal fee
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0024].bit = 7;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0024].nStartTime = 0; // activate immediately
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0024].nTimeout = 999999999999ULL;
        ...
        genesis = CreateGenesisBlock(1753734001, 1340636, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000005776e75d3d6325b324c553e92aff7818ad6322072b168d5ce73f8e4332e"));
        assert(genesis.hashMerkleRoot == uint256S("0xe0028eb9648db56b1ac77cf090b99048a8007e2bb64b68f092c03c7f56a662c7"));
        ...
        vSeeds.emplace_back("testnet-seed.dashbase.org"); // Just a static list of stable node(s), only supports x9

        // Testnet Dashbase addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Testnet Dashbase script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Dashbase BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Dashbase BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Dashbase BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        // Dashbase spork key (generated by scripts/generate_spork_keys.py)
        // privKey: cMoeVMs32wScx2xjgrGBt9iPSXVFZnTnsoYSSQXwccQmnNbyjHYb
        vSporkAddresses = {"yanj1PHeXxSwKKhMqcLsEdRXZtrQnrsE58"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;
...
public:
    explicit CDevNetParams(const ArgsManager& args) {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Dashbase: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Dashbase: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        ...
        // Dashbase spork key (generated by scripts/generate_spork_keys.py)
        // privKey: cSL3eFxdDp8EpoGman39mVxER85mzM6abmugmwoJNT4gHNTseRgK
        vSporkAddresses = {"yejXqDSRp1iToexpWmHia3sigfeqvm7jGk"};
        nMinSporkKeys = 1;
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        // Dashbase spork key (generated by scripts/generate_spork_keys.py)
        // privKey: cQTYtpMY4WkY3pMvS547mH7rFo4AuSKZVErrkcmrtCQhJscepTSP
        vSporkAddresses = {"yUkbfoKU9yidKT1SuV9ZgsKsniAGQk1sLq"};
        nMinSporkKeys = 1;
        ...
        // Regtest Dashbase addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Dashbase script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Dashbase BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Dashbase BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Dashbase BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
