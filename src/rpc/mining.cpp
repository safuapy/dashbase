...
static UniValue generatetoaddress(const JSONRPCRequest& request)
{
    RPCHelpMan{"generatetoaddress",
        "\nMine blocks immediately to a specified address (before the RPC call returns)\n",
        {
            ...
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send the newly generated Dashbase to."},
            {"maxtries", RPCArg::Type::NUM, /* default */ "1000000", "How many iterations to try."},
        },
        RPCResult{
    ...
    + HelpExampleCli("generatetoaddress", "11 \"myaddress\"")
        + "If you are running the Dashbase Core wallet, you can get a new address to send the newly generated coins to with:\n"
