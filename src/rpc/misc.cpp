...
static UniValue debug(const JSONRPCRequest& request)
{
    RPCHelpMan{"debug",
        ...
        " - \"dashbase\" activates all Dashbase-specific categories at once;\n"
        ...
        RPCExamples {
            HelpExampleCli("debug", "dashbase")
    + HelpExampleRpc("debug", "dashbase+net")
    }}.Check(request);
...
static UniValue validateaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"validateaddress",
                "\nReturn information about the given dashbase address.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The dashbase address to validate"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
static UniValue verifymessage(const JSONRPCRequest& request)
{
    RPCHelpMan{"verifymessage",
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The dashbase address to use for the signature."},
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "dashbase-cli and the GUI. There is no server-side difference.",
                {},
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* Dashbase features */
    { "dashbase",           "mnsync",                 &mnsync,                 {} },
    { "dashbase",           "spork",                  &spork,                  {"command"} },
    { "dashbase",           "sporkupdate",            &sporkupdate,            {"name","value"} },
